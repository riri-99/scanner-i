...
def _build_context(analysis: AnalysisObject, snapshot: RepoSnapshot) -> dict:
    ...
    return {
        ...
        "problem_statement": sec.render_problem_statement(analysis),
        ...
        "command_reference": sec.render_command_reference(analysis),
        ...
        "problem_statement_raw": analysis.problem_statement,
        ...
        "command_reference_list": analysis.command_reference,
